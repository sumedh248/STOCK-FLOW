...
function About() {
   return (<>
      <div className='component p-5'>
         ...
         <div className='row p-5 text-muted border-top' style={{fontSize:'1.8', lineHeight:'1.2rem'}}>
            <div className='col-6 px-5'>
               <p>We kick-started operations on the 15th of August, 2010
                  ...
                  technology. We named the company Zerodha, a I combination of Zero and "Rodha", the Sanskrit word for
                  barrier.</p>
            ...
            <div className='col-6 px-5'>
               ...
               Catch up on the latest updates on our blog or see .
